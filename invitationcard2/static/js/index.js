...
$(document).ready(function () {
    var callback = function () {
        ...
        //		audio();
        $('#page-flip,#p1 .p1-1,#p11 .p11-1,#p1 .p1-1 .p1-1-1,#p11 .p11-1 .p11-1-1 ,#p2 > div ,.s ,#p3 > div,#p33 > div').height($(window).height());
